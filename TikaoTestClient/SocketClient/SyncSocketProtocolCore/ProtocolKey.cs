...
namespace AsyncSocketServer
{
    ...
    public class ProtocolKey
    {
        ...
        public static string SQLOpen = "SQLOpen";
        public static string SQLExec="SQLExec";
        public static string BeginTrans = "BeginTrans";
        public static string CommitTrans = "CommitTrans";
        public static string RollbackTrans="RollbackTrans";
